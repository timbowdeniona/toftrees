...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "url",
      description:
        "Optional URL to link the logo to (e.g., https://www.timberyardcommerce.com/)",
      validation: (rule) =>
        rule.uri({
          allowRelative: true,
          scheme: ["http", "https"],
    ...
    defineField({
      ...
      type: "string",
      description:
        "Enter a hex color code (e.g., #FBFAF7) or rgba (e.g., rgba(251, 250, 247, 0.9)). Leave empty for default",
      validation: (rule) =>
        rule.custom((value) => {
