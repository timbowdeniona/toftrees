        ...
        switch (section._type) {
          case "heroBanner":
            return (
              <Homehero
                ...
                bodyText={
                  Array.isArray(section.bodyText)
                    ? (section.bodyText as Array<{
                        _type: string;
                        _key: string;
                        [key: string]: unknown;
                      }>)
          ...
          case "imageText":
            ...
            const imageTextPosition =
              section.imagePosition === "centre"
                ? "left"
                : ((section.imagePosition === "right" ? "right" : "left") as
                    | "left"
                    | "right");
            return (
              <ImageTextSection
          ...
          case "timeline":
            return (
              <TimelineSection
                ...
                title={section.title}
                timelineItems={
                  section.timelineItems as Array<{
                    year: string;
                    description: string;
                  }>
                }
          ...
          case "logoText":
            return (
              <LogoTextSection
                ...
                imageAltText={section.imageAltText ?? ""}
                logoPosition={
                  section.logoPosition as "left" | "right" | undefined
                }
                logoLink={section.logoLink as string | undefined}
                bodyText={
                  Array.isArray(section.bodyText)
                    ? (section.bodyText as Array<Record<string, unknown>>)
                    : []
                }
