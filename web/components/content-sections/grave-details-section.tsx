...
export function GraveDetailsSection({
  grave,
  imageMap,
}: GraveDetailsSectionProps) {
        ...
        <Flex
              ...
              <Flex
                ...
                <VStack spacing="4px" align="start" flex="1">
                  ...
                  <Text
                    ...
                    {grave.footstoneInscription ||
                      (grave.footstone ? "Yes" : "No")}
                  </Text>
                </VStack>
          ...
          {mapImage && markerPosition && (
            <Box
              ...
              aria-label="View this grave on the graveyard map"
              flex="1"
              position="relative"
