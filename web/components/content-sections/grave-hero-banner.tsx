...
export function GraveHeroBanner({
  ...
  const textAlign = hasImages
    ? { base: "center", sm: "flex-start" }
    : { base: "center", sm: "center" };
  const textJustify = hasImages
    ? { base: "flex-start", sm: "center" }
    : { base: "flex-start", sm: "center" };
  ...
  return (
    <Box bg={bannerColour} w="full" position="relative">
        ...
        <Flex
          ...
          <Flex
            ...
            <Flex
              ...
              justify={{
                base: "center",
                sm: hasImages ? "flex-start" : "center",
              }}
              flexWrap="wrap"
                ...
                <>
                  ...
                  <Box
                    ...
                    <Text
                      ...
                      {moreInfoLink.label
                        ? moreInfoLink.label.toUpperCase()
                        : "MORE INFO"}
                    </Text>
                  </Box>
                </>
      ...
      {allImages.length > 0 && (
        <Box display={{ base: "block", sm: "none" }} w="full" bg="white">
          {/* Image Carousel */}
          <Box position="relative" w="full" overflow="hidden" px="8px" pt="8px">
            <Flex
              gap="8px"
              alignItems="center"
              style={{
            ...
            <Flex
              ...
              <IconButton
                ...
                _hover={{
                  bg: "white",
                  opacity:
                    currentImageIndex === allImages.length - 1 ? 0.5 : 0.8,
                }}
                _active={{
                  bg: "white",
                  opacity:
                    currentImageIndex === allImages.length - 1 ? 0.5 : 0.6,
                }}
              />
            </Flex>
          )}
